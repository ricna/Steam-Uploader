...
export function DepotPanel({ depots, onUpdateDepot }: DepotPanelProps): JSX.Element {
  return (
    <div className="flex flex-col gap-2">
      <div className="text-xs text-[#444] uppercase tracking-wider px-1">Depots</div>
      {depots.map((depot) => (
  ...
  return (
    <div className="bg-[#141414] border border-[#1e1e1e] rounded-xl p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs text-[#666] font-mono">Depot {depot.id}</span>
      </div>
      <button
      ...
      >
        ...
        {depot.contentPath ? (
          ...
          <span className="text-xs text-[#444] flex-1">Click to select content folder…</span>
        )}
        <PencilIcon />
      </button>
    </div>
...
function FolderIcon(): JSX.Element {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      className="text-[#444] group-hover:text-[#666] flex-shrink-0"
    >
      <path
...
function PencilIcon(): JSX.Element {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      className="text-[#333] group-hover:text-[#555] flex-shrink-0"
    >
      <path
